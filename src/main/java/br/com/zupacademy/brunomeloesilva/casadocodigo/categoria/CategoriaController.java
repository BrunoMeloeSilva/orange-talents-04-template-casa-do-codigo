...
public class CategoriaController {
	...
	@Autowired
	private ProibeNomeDuplicadoParaCategoriaDTORequestValidator proibeNomeDuplicadoParaCategoriaDTORequestValidator;
	
	@InitBinder
	public void validacoesDeEntradaDasRequests(WebDataBinder webDataBinder) {
		webDataBinder.addValidators(proibeNomeDuplicadoParaCategoriaDTORequestValidator);
	}
